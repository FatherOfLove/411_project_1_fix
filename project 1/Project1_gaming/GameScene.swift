...
class GameScene: SKScene,SKPhysicsContactDelegate {
    ...
    let leftSpaceshipMin : CGFloat = -80
    
    let rightSpaceshipMax :CGFloat = 80
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        ...
        if contact.bodyA.node?.name == "leftSpaceship" || contact.bodyA.node?.name == "rightSpaceship"{
    ...
    func showRoad(){
        ...
        enumerateChildNodes(withName: "alien", using: { (leftblock, stop) in
            let alien = leftblock as! SKSpriteNode
            alien.position.y -= 10
        })
        
        enumerateChildNodes(withName: "alien", using: { (rightblock, stop) in
            let alien = rightblock as! SKSpriteNode
            alien.position.y -= 10
        })
    ...
    @objc func leftTraffic(){
        if !stopEverything{
            ...
            case 1...4:
                leftTrafficItem = SKSpriteNode(imageNamed: "alien")
                leftTrafficItem.name = "alien"
                break
            case 5...8:
                leftTrafficItem = SKSpriteNode(imageNamed: "alien")
                leftTrafficItem.name = "alien"
            ...
            case 1...4:
                leftTrafficItem.position.x = -160
                break
            case 5...10:
                leftTrafficItem.position.x = -80
                break
            default:
                leftTrafficItem.position.x = -160
            }
    ...
    @objc func rightTraffic(){
        if !stopEverything{
            ...
            switch Int(randonNumber) {
            case 1...4:
                rightTrafficItem = SKSpriteNode(imageNamed: "alien")
                rightTrafficItem.name = "alien"
                break
            case 5...8:
                rightTrafficItem = SKSpriteNode(imageNamed: "alien")
                rightTrafficItem.name = "alien"
            ...
            switch Int(randomNum) {
            case 1...4:
                rightTrafficItem.position.x = 160
                break
            case 5...10:
                rightTrafficItem.position.x = 80
                break
            default:
                rightTrafficItem.position.x = 160
            }
